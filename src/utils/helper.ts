...
const Api = {
	ok(res, data: any, message: any) {
		jsonResponse(res, data, message, {
			status: Status.OK,
		});
	},

	badRequest(res, errors: any, message: string) {
	...
	unauthorized(res, error: string, message: string) {
		const body = {
	...
	forbidden(request, res, message: string) {
		const body = {
	...
	notFound(request, res, message: string) {
		const body = {
	...
	unsupportedAction(request, res, message: string) {
		const body = {
	...
	serverError(request, res, error: any, message: string) {
	...
	created(res, data: any, message: string) {
		jsonResponse(res, data, message, {
			status: Status.OK,
		});
	},
	...
	requireHeaders(request, res, headers: any, next) {
		const missing = [] as any;
